...
namespace pixelGPUConstants {
  ...
  constexpr uint32_t maxNumberOfHits =
      48 * 1024 * 8;  // data at pileup 50 has 18300 +/- 3500 hits; 40000 is around 6 sigma away
#endif
}  // namespace pixelGPUConstants
...
namespace gpuClustering {
  ...
  constexpr uint32_t maxHitsInIter() { return 160 * 4; }
#endif
  constexpr uint32_t maxHitsInModule() { return 1024 * 2; }

  constexpr uint32_t MaxNumModules = 10000;
  ...
  constexpr uint16_t InvId = 9999*2;  // must be > MaxNumModules
