...
// //
// //   constexpr uint8_t xOffset = 81;
// //   constexpr uint8_t yOffset = 54 * 4;
// //
...
// //   constexpr uint8_t numberOfLayers = 10;
...
// //   constexpr uint32_t numberOfModulesInLadder = 8;
...
// //     // constexpr static uint8_t numberOfLaddersInBarrel = 150; //a good maximum//phase1PixelTopology::numberOfLaddersInBarrel;
// //     float ladderZ[150];
// //     float ladderX[150];
// //     float ladderY[150];
// //     float ladderR[150];
