...
namespace phase1PixelTopology {
  ...
  constexpr uint16_t layerStart[numberOfLayers + 1] = {0,
                                                       96,
                                                       320,
                                                       672,  // barrel
                                                       1184,
  ...
  static_assert(validateLayerIndex(), "phase1 layer from detIndex algo is buggy");
...
namespace phase2PixelTopology
{
    ...
    constexpr uint16_t layerStart[numberOfLayers + 1] = {0,108, 324, 504, 756, 864, 972,
